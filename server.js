...
app.get("/api/makeNostrProfiles", async (req, res) => {
  console.log('about to make the call');  
  let rsslayGetEndpoint = "https://rsslay.nostr.moe/api/feed?url=https://nitter.moomoo.me/elonmusk/rss"
  https.post(rsslayGetEndpoint,
    (data) => {
